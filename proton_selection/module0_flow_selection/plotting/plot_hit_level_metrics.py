...
def plot_channel_metrics(d, is_mc):
    ...
    ax1.hist(bins1tot[:-1], bins=bins1tot, weights = counts1tot)
    ax1.set_xlabel('Max Hit Amplitude / Channel / Event [mV]')
    ax1.set_ylabel('Channel Count / 20 mV')
    ...
    ax2.hist(bins2tot[:-1], bins=bins2tot, weights = counts2tot)
    ax2.set_xlabel('Min Hit Amplitude / Channel / Event [mV]')
    ax2.set_ylabel('Channel Count / 20 mV')
    ...
    ax3.set_xlabel('First Hit Amplitude / Channel / Event [mV]')
    ax3.set_ylabel('Channel Count / 20 mV')
    ...
    ax4.set_xlabel('Last Hit Amplitude / Channel / Event [mV]')
    ax4.set_ylabel('Channel Count / 20 mV')
